...
CONSTRAINT Role_Skill_Proficiency_fk1 FOREIGN KEY (Role_Listing_ID) REFERENCES Role_Listing_ID(Role_Listing_ID),
CONSTRAINT Role_Skill_Proficiency_fk2 FOREIGN KEY (Skill_Name) REFERENCES Staff_Skill(Skill_Name)
);
...
CREATE TABLE Extra_Skill ( -- staff can input x-factor skill
  ...
  CONSTRAINT Extra_Skill FOREIGN KEY (Staff_ID) REFERENCES Apply_Role(Staff_ID),
  CONSTRAINT Extra_Skill FOREIGN KEY (Role_Listing_ID) REFERENCES Apply_Role(Role_Listing_ID)
);
...
PRIMARY KEY (Staff_ID,Role_Listing_ID),
CONSTRAINT Role_Status FOREIGN KEY (Staff_ID) REFERENCES Apply_Role(Staff_ID),
CONSTRAINT Role_Status FOREIGN KEY (Role_Listing_ID) REFERENCES Apply_Role(Role_Listing_ID)
);
