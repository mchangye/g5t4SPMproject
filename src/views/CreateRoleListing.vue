  ...
  <main class="pt-3">
    <div class="container ms-1">
      <div class="mb-5">
        ...
        <div class="row">
          <label for="role_description"><p id="description" class="fw-bold mb-0 mt-3">Role Description</p></label><br />
          <textarea
            id="role_description"
        ...
        <div class="row">
          ...
          <div class="col">
            <label for="Role_country_ID"><p id='country' class="fw-bold mb-0 mt-3">Role Country</p></label><br />
        ...
        <div class="row">
          <div class="col">
            <label for="Role_Department_ID"><p id="department" class="fw-bold mb-0 mt-3">Role Department</p></label><br />
          ...
          <div class="col">
            <label for="expiry_date"><p id="date" class="fw-bold mb-0 mt-3">Expiry Date</p></label><br />
            <input
              type="date"
              id="expiry_date"
              name="expiry_date"
          ...
          <div v-if="date_check == 2">
            <p style="color: red;">Please check if the expiry date is before today's date.</p>
          </div>
          </div>
        </div>
        ...
        <button type="button" v-on:click="postListing()" class="btn btn-primary">Submit</button>
      </div>
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      Role_ID: 0,
      get_roles: [{ Role_ID: 0, Role_Name: "Select a role", Role_Desc: "rherherhj" }],
      get_skills: [],
      get_countries: [],
      get_departments: [],
      role_check: 0,
  ...
  methods: {
    postListing() {
      ...
      axios
        .post("http://localhost:5000/api/createrole", {
